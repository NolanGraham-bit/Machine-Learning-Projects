...
#
# Objective:
# Train and evaluate a Decision Tree model for WiFi channel classification,
...
Z = dt_model.predict(pca.inverse_transform(np.c_[xx.ravel(), yy.ravel()])).reshape(xx.shape)
...
plt.savefig("Decision_Boundary_DecisionTree.png")
plt.show()
