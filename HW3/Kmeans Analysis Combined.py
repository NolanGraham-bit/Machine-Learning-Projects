...
# Nolan Graham
# ML – HW#3
# Filename: Kmeans Analysis Combined.py
#
# Objective:
# To perform K-Means clustering on the combined dataset (2011-2015), determine the 
# optimal number of clusters using the Elbow Method, and analyze clustering results 
...
print("All plots and results for the combined dataset have been saved successfully!")
