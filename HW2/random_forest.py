...
#
# Objective:
# Train and evaluate a Random Forest model for WiFi channel classification,
...
Z = rf_model.predict(pca.inverse_transform(np.c_[xx.ravel(), yy.ravel()])).reshape(xx.shape)
...
plt.savefig("Decision_Boundary_RandomForest.png")
plt.show()
